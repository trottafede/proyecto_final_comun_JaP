document.addEventListener("DOMContentLoaded", () => {
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav w-100 justify-content-between">
      ...
      <li class="nav-item mb-2 d-md-none d-lg-none d-xl-none"><a class="nav-link" href="./cart.html"><i class="fa-solid fa-cart-shopping"></i> Mi Carrito</a></li>
      <li class="nav-item mb-3 d-md-none d-lg-none d-xl-none"><a class="dropdown-item" href="./nosotros.html"><i class="fa-solid fa-users"></i> Nosotros</a></li>
